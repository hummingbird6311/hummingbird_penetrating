...
TU01 ='810a001c01040004ed100c004000081e09552e4441f800002f39081f'
TU02 ='810a001c01040004f5100c0040000c1e09552e4441f800002f39081f'
TD01 ='810a001c01040004ed100c004000081e09552e44415000002f39081f'
TD02 ='810a001c01040004f5100c0040000c1e09552e44415000002f39081f'
...
tu_01 = binascii.unhexlify(TU01)
tu_02 = binascii.unhexlify(TU02)
td_01 = binascii.unhexlify(TD01)
td_02 = binascii.unhexlify(TD02)
...
for i in range(0,5):
    ...
    sleep(SLEEP_TIME)
    ip.id += 2
    pkt = eth/ip/udp/tu_01
    sendp(pkt,iface=IF)
    sleep(SLEEP_TIME)
    ip.id += 2
    pkt = eth/ip/udp/tu_02
    sendp(pkt,iface=IF)
    sleep(SLEEP_TIME)
    ip.id += 2
    pkt = eth/ip/udp/td_01
    sendp(pkt,iface=IF)
    sleep(SLEEP_TIME)
    ip.id += 2
    pkt = eth/ip/udp/td_02
    sendp(pkt,iface=IF)
    sleep(SLEEP_TIME)
